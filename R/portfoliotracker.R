...
if (getRversion() >= "2.15.1") {
  utils::globalVariables(c("path.data", "path.tickers", "path.prices.raw",
                           ...
                           "path.value.panel", "file.transactions", "file.current",
                           "file.previous", "file.tickers", "file.dividend.history",
                           "file.dividend.year", "file.dividend.month",  "file.target.shares",
